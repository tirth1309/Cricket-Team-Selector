      ...
      <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
        <div class="card card-signin my-5">
          <div class="card-body">
            ...
            <form class="form-signin" method="POST" action="update_all.php">
              ...
              <?php
                ...
                if(isset($_POST['name']) && isset($_POST['economy']))
                {
                  ...
                  else
                  {
                    ...
                    //echo "Checking ....";
                    $sql = "UPDATE project.all_rounder set Bat_Avg=$avg,St_Rate=$strike,Economy=$economy,Wickets_per_match=$wicketspm,Matches=$matches) where All_Name='$name'";
